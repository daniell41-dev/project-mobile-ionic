...
export class DataService {
  ...
  readonly transactions = signal<Transaction[]>([
    {
      ...
      category: 'Ingresos',
      categoryIcon: 'cash',
      categoryColor: '#3FD1A0',
      date: new Date(),
      time: '08:02',
      status: 'completed',
      reference: 'NOM202406010001',
      method: 'SPEI',
      fee: 0,
    },
    {
      ...
      time: '07:41',
      status: 'completed',
      reference: 'SPT202406010001',
      method: 'Cargo automático',
      fee: 0,
    },
    {
      id: 't3',
  ...
  readonly statsCategories = signal([
    { name: 'Alimentos', percent: 32, color: '#4C8DFF' },
    { name: 'Transporte', percent: 18, color: '#3FD1A0' },
    { name: 'Entretenimiento', percent: 15, color: '#F5A623' },
    { name: 'Compras', percent: 20, color: '#9B59B6' },
    { name: 'Servicios', percent: 10, color: '#FF8A8A' },
    { name: 'Otros', percent: 5, color: '#626C7C' },
  ]);
